...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ADAPTABILITY, ABILITY_KEEN_EYE, ABILITY_FRISK },
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_KEEN_EYE, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .baseDefense   = 64,
        .baseSpeed     = 90,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_7 ? 100 : 76,
        .baseSpDefense = 96,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING),
        .catchRate = 90,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_LEAF_GUARD, ABILITY_FLUFFY },
    #else
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_FLUFFY },
    #endif
        .bodyColor = BODY_COLOR_PINK,
